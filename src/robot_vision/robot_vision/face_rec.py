...
class FaceRecognition(Node):
    def __init__(self):
        ...
        self.EMBEDDINGS_PATH = resolve_project_path('data/face_embeddings_tester.npy')
        ...
        self.app = FaceAnalysis(name='buffalo_sc',root=resolve_project_path('insightface').as_posix(),  allowed_modules=['detection', 'recognition'])
